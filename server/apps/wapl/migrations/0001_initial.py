    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wapl.publicplan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(default='')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('plan_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wapl.privateplan')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
